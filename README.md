...
| 场景 | 框架 | 吞吐量 (TPS) | 平均响应时间 | P99.9 延迟 |
      |------|------|-------------|-------------|-----------|
| 单线程（50k 次） | Kanketsu | – | 0.0083 ms | 0.0777 ms |
| 单线程（50k 次） | Picocli  | – | 0.0149 ms | 0.0547 ms |
| 并发（8线程，160k任务） | **Kanketsu** | **403,022** | 0.0083 ms | 0.0777 ms |
| 并发（8线程，160k任务） | Picocli  | 126,083 | 0.0607 ms | 0.5331 ms |

> 并发场景下，Kanketsu 的吞吐量是 Picocli 的 **3.2 倍**，平均延迟低约 **86%**，P99.9 低约 **85%**。
>
